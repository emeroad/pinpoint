 ...
 */
@Component
public class PinotSystemMetricDoubleMapper implements SystemMetricMapper<Double> {
    @Override
    ...
    @Override
    public List<SampledSystemMetric<Double>> mapSampledSystemMetric(List<Map<String, String>> resultMap) {
